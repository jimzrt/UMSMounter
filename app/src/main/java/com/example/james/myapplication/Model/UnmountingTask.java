...
public class UnmountingTask extends Task {
    ...
    @Override
    public void execute() {
        Shell.Sync.sh(new String[]{"setprop sys.usb.config none", "echo \"\" > /config/usb_gadget/g1/UDC", "echo \"\" > /config/usb_gadget/g1/functions/mass_storage.0/lun.0/file", "setprop sys.usb.config " + oldFunctions});
